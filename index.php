...
<body>
  ...
  <div style="margin-top: -30px; z-index: -1" id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <div style="background-image: url(img/11.jpg);background-size: 100%; height: 700px;">
          <div style="" class='title-wrap'>
            <marquee behavior="alternate" direction='left'>
              <h1 class='all_titles' style="color: #fffff">Choose a job you love</h1>
            </marquee>
          </div>
        </div>
      </div>
      ...
      <div class="item">
        <div style="background-image: url(img/9.jpg);background-size: 100%; height: 700px;">
          <div class='title-wrap'>

            <h1 class='all_titles' style="color: #fffff; ">The home of your dream job</h1>
      ...
      <div class="item">
        <div style="background-image: url(img/8.jpg);background-size: 100%; height: 700px;">
          <div style="" class='title-wrap'>
            ...
            <h1 class='all_titles' style="color: #fffff;">Exceed your potential… come join us!</h1>
  ...
  <div class='jobs' style='margin-top: 30px; margin-bottom: 30px;'> <br />
    ...
    <h1 style="text-align: center; color:#fffff"> Find latest job openings</h1>
  ...
  <div class='jobs' style='margin-top: 30px; margin-bottom: 30px;'> <br />
    <h1 style="text-align: center;color:#fffff">Companies Registered with Us </h1><br />
    <div class="container" style="background-color: whitesmoke">
      <div style="height:auto; margin-left:6%; margin-top:30px; text-align: justify;
        vertical-align: top; ">
        <div class="row div_products">
          <?php
  ...
  <h1 style="text-align: center;color:#fffff">Job Seekers Reviews </h1>
  <?php require_once('reviews.php'); ?>
  <div style="height: 120px"></div>
  <h1 style="text-align: center;color:#fffff">Job Industries </h1>
  <div class="container">
    <?php
