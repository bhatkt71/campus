...
<body onload="Captcha1()">
  ...
  <div class='container' >
    ...
    <h3  class='one' >On registering, you can </h3>
    <div class='hr'> </div>
    <h4 style="text-align:center;font-weight:500; color:white; background-color: #337ab7;
    padding: 10px; font-size: 18px; margin-left:10pxpx">Find a job & grow your career</h4>
    <div class='hr'> </div>
